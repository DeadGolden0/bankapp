...
class TransferAmountWidget extends StatefulWidget {
  const TransferAmountWidget({super.key});

  @override
  State<TransferAmountWidget> createState() => _TransferAmountWidgetState();
}
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: TextFormField(
                                                    ...
                                                    decoration: InputDecoration(
                                                      ...
                                                      hintText:
                                                          'Veuillez entrer le montant à transférer.',
                                                      hintStyle:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .labelMedium
