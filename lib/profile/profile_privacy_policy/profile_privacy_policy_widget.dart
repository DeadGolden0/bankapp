...
import 'profile_privacy_policy_model.dart';
export 'profile_privacy_policy_model.dart';

class ProfilePrivacyPolicyWidget extends StatefulWidget {
  const ProfilePrivacyPolicyWidget({super.key});

  @override
  State<ProfilePrivacyPolicyWidget> createState() =>
      _ProfilePrivacyPolicyWidgetState();
}

class _ProfilePrivacyPolicyWidgetState
    extends State<ProfilePrivacyPolicyWidget> {
  late ProfilePrivacyPolicyModel _model;
